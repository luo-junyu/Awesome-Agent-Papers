...
- **[Implicit Behavioral Alignment of Language Agents in High-Stakes Crowd Simulations](https://aclanthology.org/2025.emnlp-main.1562/)** (*2025*) `EMNLP`
  > This paper introduces PersonaEvolve (PEvo), an optimization algorithm that iteratively adjusts LLM agent personas to produce realistic crowd behaviors in crowd-based social simulations, improving behavior realism.
