...
- **[CoMAS: Co-Evolving Multi-Agent Systems via Interaction Rewards](https://arxiv.org/abs/2510.08529)** (*2025*)
  > Introduces CoMAS, a framework enabling agents to self-evolve by learning from inter-agent interactions without external supervision, generating intrinsic rewards from discussion dynamics.
...
- **[GenoMAS: A Multi-Agent Framework for Scientific Discovery via Code-Driven Gene Expression Analysis](https://arxiv.org/abs/2507.21035)** (*2025*)
  > Introduces GenoMAS, a multi-agent framework combining guided-planning with autonomous error handling for gene expression analysis, surpassing prior methods by over 10%.

- **[aiXiv: A Next-Generation Open Access Ecosystem for Scientific Discovery Generated by AI Scientists](https://arxiv.org/abs/2508.15126)** (*2025*)
  > Introduces aiXiv, an open-access platform where multi-agent architecture enables AI and human scientists to collaborate on research submission, peer review, and iterative refinement.
...
- **[GenoTEX: An LLM Agent Benchmark for Automated Gene Expression Data Analysis](https://arxiv.org/abs/2406.15341)** (*2025*)
  > Introduces GenoTEX, a benchmark for evaluating LLM-based agents on gene expression analysis tasks. Accepted as Oral paper at MLCB 2025.
...
- **[Achilles Heel of Distributed Multi-Agent Systems](https://arxiv.org/abs/2504.07461)** (*2025*)
  > Studies trustworthiness challenges in Distributed Multi-Agent Systems (DMAS), identifying four critical issues: free riding, malicious attacks, communication overhead, and data privacy.
...
- **[The Landscape of Agentic Reinforcement Learning for LLMs: A Survey](https://arxiv.org/abs/2509.02547)** (*2025*)
  > Comprehensive survey on agentic RL for LLMs. Proposes taxonomy organized around core agentic capabilities and applications across diverse task domains.
