...
- **[Beyond Offline A/B Testing: Context-Aware Agent Simulation for Recommender System Evaluation](https://arxiv.org/abs/2604.09549)** (*2026*) `arxiv`
  > The paper proposes a a framework for evaluating recommender systems via agent interactions. It leverages thought synthesis to align agents with their personas and preferences.
